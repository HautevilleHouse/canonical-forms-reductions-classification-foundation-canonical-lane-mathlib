...
def sourceRepository : String :=
  "canonical-forms-reductions-classification-foundation"

def sourceDescription : String :=
  "Canonical Forms Reductions Classification Foundation"

def sourceTheoremBoundary : SourceTheoremBoundary :=
  { claimBoundary := "Canonical forms reduction exists" }
...
def ClassicalSourceBoundaryCarried : Prop :=
  sourceTheoremStatement.classicalBoundary = sourceTheoremBoundary.claimBoundary
